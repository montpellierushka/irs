...
<div class="row">
	<div class="col-12">
		<div class="card">
			...
			<div class="card-body">
				<form method="POST" action="{{route('admin_services_update')}}">
										...
										<div class="card-header">
											...
											<div class="card-body">
												<div class="form-group">
													...
													<input type="text" class="form-control mytranslit @error('title') is-invalid @enderror" name="title" value="{{ old('title', $service->title) }}" placeholder="" required>
												</div>  
												<div class="form-group">
													...
													<table class="table dataTable table-hover m-0 dynamic-table" style="margin:0 !important" data-tab="gifts">
														...
														<tbody>
															@foreach($gifts as $i => $gift)
																<tr>
																	<td>
																			<input type="text" name="content[gifts][{{ $i }}][title]" value="{{ old('content.gifts.' . $i . '.title', $gift['title'] ?? '') }}" class="form-control" required>
																	</td>
																	<td>
													...
													<table class="table dataTable table-hover m-0 dynamic-table" style="margin:0 !important" data-tab="whys">
														...
														<tbody>
															@foreach($whyItems as $i => $why)
																<tr>
																	<td>
																			<input type="text" name="content[whys][items][{{ $i }}][title]" value="{{ old('content.whys.items.' . $i . '.title', $why['title'] ?? '') }}" class="form-control" required>
																	</td>
																	<td>
																			<button type="button" class="btn btn-danger btn-sm remove-row">Удалить</button>
																	</td> 
										...
										<table class="table dataTable table-hover m-0 dynamic-table" style="margin:0 !important" data-tab="helps">
											...
											<tbody>
												@foreach($helps as $i => $help)
													<tr>
														<td>
																<input type="text" name="content[helps][{{ $i }}][digit]" value="{{ old('content.helps.' . $i . '.digit', $help['digit'] ?? '') }}" class="form-control" required>
														</td>
														<td>
																<input type="text" name="content[helps][{{ $i }}][subtitle]" value="{{ old('content.helps.' . $i . '.subtitle', $help['subtitle'] ?? '') }}" class="form-control" required>
														</td>
														<td>
																<input type="text" name="content[helps][{{ $i }}][text]" value="{{ old('content.helps.' . $i . '.text', $help['text'] ?? '') }}" class="form-control" required>
														</td>
														<td>
																<button type="button" class="btn btn-danger btn-sm remove-row">Удалить</button>
														</td> 
												...
												<table class="table dataTable table-hover m-0 dynamic-table" style="margin:0 !important" data-tab="works">
													...
													<tbody>
														@foreach($workItems as $i => $work)
															<tr>
																<td>
																		<input type="text" name="content[works][items][{{ $i }}][title]" value="{{ old('content.works.items.' . $i . '.title', $work['title'] ?? '') }}" class="form-control" required>
																</td>
																<td>
																		<input type="text" name="content[works][items][{{ $i }}][text]" value="{{ old('content.works.items.' . $i . '.text', $work['text'] ?? '') }}" class="form-control" required>
																</td>
																<td>
																		<button type="button" class="btn btn-danger btn-sm remove-row">Удалить</button>
																</td> 
												...
												<table class="table dataTable table-hover m-0 dynamic-table" style="margin:0 !important" data-tab="whywes">
													...
													<tbody>
														@foreach($whywes as $i => $whywe)
															<tr>
																<td>
																		<input type="text" name="content[whywes][{{ $i }}][title]" value="{{ old('content.whywes.' . $i . '.title', $whywe['title'] ?? '') }}" class="form-control" required>
																</td>
																<td>
																		<button type="button" class="btn btn-danger btn-sm remove-row">Удалить</button>
																</td> 
											...
											<table class="table dataTable table-hover m-0 dynamic-table" style="margin:0 !important" data-tab="trusts">
												...
												<tbody>
													@foreach($trusts as $i => $trust)
														<tr>
															<td>
																	<input type="text" name="content[trusts][{{ $i }}][img]" value="{{ old('content.trusts.' . $i . '.img', $trust['img'] ?? '') }}" placeholder="ссылка из медиабиблиотеки" class="form-control" required>
															</td>
															<td>
																	<button type="button" class="btn btn-danger btn-sm remove-row">Удалить</button>
															</td> 
											...
											<table class="table dataTable table-hover m-0 dynamic-table" style="margin:0 !important" data-tab="projects">
												...
												<tbody>
													@foreach($projects as $i => $project)
														<tr>
															<td>
																	<input type="text" name="content[projects][{{ $i }}][title]" value="{{ old('content.projects.' . $i . '.title', $project['title'] ?? '') }}" class="form-control" required>
															</td>
															<td>
																	<input type="text" name="content[projects][{{ $i }}][text]" value="{{ old('content.projects.' . $i . '.text', $project['text'] ?? '') }}" class="form-control" required>
															</td>
															<td>
																	<input type="text" name="content[projects][{{ $i }}][img]" value="{{ old('content.projects.' . $i . '.img', $project['img'] ?? '') }}" placeholder="ссылка из медиабиблиотеки" class="form-control" required>
															</td>
															<td>
																	<input type="text" name="content[projects][{{ $i }}][link]" value="{{ old('content.projects.' . $i . '.link', $project['link'] ?? '') }}" class="form-control" required>
															</td>
															<td>
																	<button type="button" class="btn btn-danger btn-sm remove-row">Удалить</button>
															</td> 
												...
												<table class="table dataTable table-hover m-0 dynamic-table" style="margin:0 !important" data-tab="chooses">
													...
													<tbody>
														@foreach($chooses as $i => $choose)
															<tr>
																<td>
																		<input type="text" name="content[chooses][{{ $i }}][title]" value="{{ old('content.chooses.' . $i . '.title', $choose['title'] ?? '') }}" class="form-control" required>
																</td>
																<td>
																		<button type="button" class="btn btn-danger btn-sm remove-row">Удалить</button>
																</td> 
