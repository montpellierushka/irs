					...
					<tbody>
						<?foreach($pages as $page){?>
							<tr> 
								<td><?=$page->id?></td> 
								<td><?=$page->title?></td>  
								<td><a href="{{url(route('admin_pages').'/'.$page->id)}}">Подробнее</a></td>
								<td><a href="javascript:;" class="open-delete" data-id="<?=$page->id?>" data-toggle="modal" data-target="#modal-delete">Удалить</a></td>
							</tr> 
						<?}?>
					</tbody>
				</table>
...
<div class="modal fade" id="modal-delete">
	<div class="modal-dialog">
		<form method="POST" action="{{ route('admin_pages_delete') }}" class="modal-content">
			@csrf
			...
			<div class="modal-body">
				<p>Вы уверены в том что хотите удалить страницу #<b><i></i></b>?</p>
			</div>
