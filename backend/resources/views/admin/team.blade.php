					...
					<tbody>
						<?foreach($team as $el){?>
							<tr> 
								...
								<td><?=$el->role?></td>  
								<td><?=$el->sort?></td>
								<td><a href="{{url(route('admin_team').'/'.$el->id)}}">Подробнее</a></td>
...
<div class="modal fade" id="modal-delete">
	<div class="modal-dialog">
		<form method="POST" action="{{ route('admin_team_delete') }}" class="modal-content">
			@csrf
			...
			<div class="modal-body">
				<p>Вы уверены в том что хотите удалить сотрудника #<b><i></i></b>?</p>
			</div>
