...
export default function Vacancies ({ fetchInitialData, serverData }) {    
            ...
            <div className={'page-wrapper'}>
                ...
                <div className={'page-content'}>
                    ...
                    {(() => {
                        ...
                        return <>
                            <Aboutnav h1={'Вакансии'}/>
                            {content.map((item, i) => { 
                                return(     
                                    <Link to={"/vacancies/"+item.slug} className={classes.vacancies__element} key={"vacancies"+i}> 
                                        <div className={classes.vacancies__title} dangerouslySetInnerHTML={{__html: item.title}} /> 
                                        <div className={classes.vacancies__excerpt} dangerouslySetInnerHTML={{__html: item.excerpt}} /> 
                                    </Link>                         
                                )
                            })}    
                        </>
