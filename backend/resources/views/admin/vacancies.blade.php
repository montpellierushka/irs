					...
					<tbody>
						<?foreach($vacancies as $v){?>
							<tr> 
								...
								<td><a href="javascript:;" class="open-delete" data-id="<?=$v->id?>" data-toggle="modal" data-target="#modal-delete">Удалить</a></td>
							</tr> 
						<?}?>
					</tbody>
				</table>
...
<div class="modal fade" id="modal-delete">
	<div class="modal-dialog">
		<form method="POST" action="{{ route('admin_vacancies_delete') }}" class="modal-content">
			@csrf
			...
			<div class="modal-body">
				<p>Вы уверены в том что хотите удалить вакансию #<b><i></i></b>?</p>
			</div>
